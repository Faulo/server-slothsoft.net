        ...
        <sitemap version="1.0">
            ...
            <page name="PersonalStudies" title="Personal Studies" status-active="" redirect="/">
                ...
                <page name="Daniel" title="Daniel" status-active="" status-public="" ref="kana-home">
                    ...
                    <page name="Grammar" title="Grammar" ref="vocab-verbs" status-active="" status-public="" />
                    <!-- <page name="Mobile" title="Mobile Pages" redirect="KanjiJaEn" status-active="" status-public=""> <sfm:param name="test-type" value="click"/> <page name="VocabJaDe" title="Vocab Test Japanese-German" ref="kana-vocab-mobile" status-active="" status-public=""> <sfm:param name="test-language" 
                        value="ja-jp"/> </page> <page name="VocabDeJa" title="Vocab Test German-Japanese" ref="kana-vocab-mobile" status-active="" status-public=""> <sfm:param name="test-language" value="de-de"/> </page> <page name="KanjiJaEn" title="Kanji Test Japanese-English" ref="vocab-kanji-mobile" status-active="" status-public=""> 
                        <sfm:param name="test-language" value="ja-jp"/> </page> <page name="KanjiEnJa" title="Kanji Test English-Japanese" ref="vocab-kanji-mobile" status-active="" status-public=""> <sfm:param name="test-language" value="en-us"/> </page> </page> -->
                ...
                <page name="Julia" title="Julia" status-active="" status-public="" redirect="VocabularyList">
                    ...
                    <!-- <page name="VocabularyTest" title="Vocabulary Test" redirect="English-German" status-active="" status-public=""> <page name="English-German" title="English-German" ref="kana-vocab" status-active="" status-public=""> <sfm:param name="test-language" value="en-us"/> </page> <page 
                        name="English-German-Plus" title="English-German-Plus" ref="kana-vocab" status-active="" status-public=""> <sfm:param name="test-language" value="en-us"/> <sfm:param name="test-type" value="typing"/> </page> <page name="German-English" title="German-English" ref="kana-vocab" status-active="" status-public=""> 
                        <sfm:param name="test-language" value="de-de"/> </page> <page name="German-English-Plus" title="German-English-Plus" ref="kana-vocab" status-active="" status-public=""> <sfm:param name="test-language" value="de-de"/> <sfm:param name="test-type" value="typing"/> </page> </page> -->
                </page>
            </page>
        </sitemap>
    </xsl:template>
